...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ISSUE_ASSIGNED', 'ISSUE_STATUS_CHANGED', 'COMMENT_CREATED', 'MENTIONED', 'INVITED');
...
-- CreateIndex
CREATE UNIQUE INDEX "teams_organizationId_key_key" ON "teams"("organizationId", "key");
